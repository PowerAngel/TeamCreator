...
public class SixTeams extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ListView listView_Team6 = (ListView) this.findViewById(R.id.listView_Team6);
        ...
        adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, AllNamesArray.get(5));
        listView_Team6.setAdapter(adapter);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_six_teams, menu);
        return true;
    }
